    ...
    public static class WikiParser
    {
        public static IEnumerable<WikiNode> Parse(string page)
        {
            ...
            while (idx < page.Length)
            {
                ...
                {
                    case 0: // <!--
                        yield return ParseTextGreedy(page, WikiTextNodeType.Comment, idx, out idx);
                        break;
                    case 1: // {|
                    ...
                    case 2: // {{
                        ...
                        break;
                    case 6: // ==
                        yield return ParseTextGreedy(page, WikiTextNodeType.Section2, idx, out idx);
                        break;
                    case 5: // ===
                        yield return ParseTextGreedy(page, WikiTextNodeType.Section3, idx, out idx);
                        break;
                    case 4: // ====
                        yield return ParseTextGreedy(page, WikiTextNodeType.Section4, idx, out idx);
                        break;
                    case 3: // =====
                        yield return ParseTextGreedy(page, WikiTextNodeType.Section5, idx, out idx);
                        break;
        ...
        private static WikiTemplateNode ParseTemplate(string page, int start, out int idx)
        {
            ...
            while (idx < page.Length)
            {
                ...
                {
                    case 0: // <!--
                        node.Children.Add(ParseTextGreedy(page, WikiTextNodeType.Comment, idx, out idx));
                        break;
                    case 1: // {{
